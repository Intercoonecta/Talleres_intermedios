...
# 
# # Entonces podemos instalar vocc:
# devtools::install_github("JorGarMol/VoCC", dependencies = TRUE, build_vignettes = TRUE)
# 
...
# 
# # Otra opción más que requerirá menos tiempo
# library(VoCC)
# citation("VoCC") # para citar el uso de este paquete concreto
# 
...
```{r paquetes ya instalados, include=FALSE} 
...
agg_yr_sst <- aggregate(yr_sst, fact = 10) # 0.5º, podemos jugar con el fact = número, para ver cómo cambia la resolución
agg_yr_sst
