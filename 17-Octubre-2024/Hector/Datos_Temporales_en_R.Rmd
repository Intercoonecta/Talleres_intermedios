...
Una vez explicadas las clases especializadas para fechas-tiempo en R, vamos a ilustrar la manipulación de este tipo de información utilizando el producto *Global Ocean Physics Reanalysis* (<https://doi.org/10.48670/moi-00021>) de Copernicus (<https://marine.copernicus.eu/>).
...
Inspeccionando un poco el archivo (tecleando `ncf` en la consola de R) podemos notar que estos valores corresponden al número de segundos desde el primero de enero de 1970: "units: seconds since 1970-01-01 00:00:00", por lo que la conversión apropiada sería
...
Para la figura necesitamos sin embargo combinar las columnas mes y año, definiendo un día (el 1 en este ejemplo).
