...
Para ilustrar la manipulación de datos temporales utilizaremos información de la temperatura potencial diaria del producto *Global Ocean Physics Reanalysis*\[\^1\] de Copernicus (<https://marine.copernicus.eu/>)
