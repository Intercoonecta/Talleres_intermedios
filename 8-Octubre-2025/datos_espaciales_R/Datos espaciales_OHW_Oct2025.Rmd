...
![](Captura de pantalla 2025-10-06 a las 11.19.28.png){fig-align="center" width="500"}
![](Captura de pantalla 2025-10-06 a las 11.19.30.png){fig-align="center" width="500"}
![](Captura de pantalla 2025-10-06 a las 11.19.34.png){fig-align="center" width="500"}
![](Captura de pantalla 2025-10-06 a las 11.19.38.png){fig-align="center" width="500"}
![](Captura de pantalla 2025-10-06 a las 11.19.46.png){fig-align="center" width="500"}
![](Captura de pantalla 2025-10-06 a las 11.19.51.png){fig-align="center" width="500"}
![](Captura de pantalla 2025-10-06 a las 11.19.58.png){fig-align="center" width="500"}
![](Captura de pantalla 2025-10-06 a las 11.20.03.png){fig-align="center" width="500"}
![](Captura de pantalla 2025-10-06 a las 11.20.09.png){fig-align="center" width="500"}
![](Captura de pantalla 2025-10-06 a las 11.20.20.png){fig-align="center" width="500"}
![](Captura de pantalla 2025-10-06 a las 11.20.39.png){fig-align="center" width="500"}
![](Captura de pantalla 2025-10-06 a las 11.20.45.png){fig-align="center" width="500"}
...
Paquetes importantes a usar para trabajar SIG en R
raster: importar, exportar y analizar datos ráster
sp: analizar datos espaciales (vectoriales)
...
# tenemos que descargarnos datos de SST de un servidor de datos, por ejemplo Copernicus. Julia Jaca nos explicará como en el tutorial de mañana. 
...
# A veces copernicus descataloga productos y desaparecen cosas y luego tienes que pedirles por email y es más dificil. Es importante que cuando desgargues unos datos guardes toda la información sobre ellos para poder explicar posteriormente el trabajo que hay hecho, citar la referencia o pedir una ampliación de ese mismo producto. 
...
# OPCIÓN A, to play with SST data

source_data("https://github.com/JorGarMol/VoCC_data_sets/blob/master/Data/HadiSST.rda?raw=true")      # HSST data set

# para aprender más, consultar su github: https://github.com/JorGarMol/VoCC, el tutorial y el artículo del paquete VoCC https://besjournals.onlinelibrary.wiley.com/doi/full/10.1111/2041-210X.13295 


HadiSST

# podemos ver que son datos mensuales desde 1955 
# y de todo el mundo, 

class(HadiSST) # este ya es un fichero raster
names(HadiSST) # desde 1955 hasta 2010

1954 - 2010 # 56 años
56*12 # 672 capas, layers, una para mes, indicado en las dimensions
# resolución de 1 grado. dimensiones 1.0 grado latitude x 1.0 grado de longitud del grid global que hacen 360x180, indicado en las 
# dimensions nrow, rcol.

plot(HadiSST[[1]])

#OPTCIÓN B, if you have aldready downloaded data in format "nc" in your local computer
...
```{r sumSeries OPCIÓN A, include=FALSE}
...
# Promedio anual de SST (ºC), conviertiendo días en años

yr_sst <- sumSeries(HadiSST, 
                    p = "1960-01/2009-12", # año-mes inicial, año-mes final de mi serie de datos
                    yr0 = "1955-01-01", # día inicial desde la que quiero que comience los cálculos
                    l = nlayers(HadiSST), # mi fichero
                    fun = function(x) colMeans(x, na.rm = TRUE), 
                    freqin = "months", freqout = "years") # los datos entran mensuales y salen en promedio anual

plot(yr_sst) # un plot para cada año
slotNames(yr_sst)
nlayers(yr_sst)
dim(yr_sst)
1960-2009 # 50 años de datos

yr_sst #resolution 1,1 1ºx1º, 1º= 111 km

```


```{r sumSeries OPCIÓN B, include=FALSE}
#  la función sumSeries te calcula el promedio anual, o mensual, pasando de días a meses, o meses a años, lo que tu quieras
# ?sumSeries 
# aquí tenemos toda la información de esta función en inglés
# para pasar de ºK a ºC hago esto: colMeans(x- 273.15, na.rm = TRUE)
...
```{r cortar poligono para el Mediterráneo}
...
```{r consejo para marcar varias filas con texto #}
