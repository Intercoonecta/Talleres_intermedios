...
author: "Nicolás Loi, Jorge Cornejo"
date: "`r Sys.Date()`"
#output:
...
Aquí se debe ir a descargar los datos desde Global Fishing Watch [https://globalfishingwatch.org/map](https://globalfishingwatch.org/map).
